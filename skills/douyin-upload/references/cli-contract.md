...
- Obrigatório:
  - `--account`
- O que faz:
  - inicia o login no Douyin e gera ou renova o arquivo de cookie da conta
...
- o `upload-note` não aceita GIF
- o `upload-note` aceita no máximo 35 imagens
